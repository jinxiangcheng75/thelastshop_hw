...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ButtonClickTween", _m_ButtonClickTween);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ButtonClickTween(RealStatePtr L)
        {
		    try {
                ...
                {
                    DG.Tweening.TweenCallback _clickListener = translator.GetDelegate<DG.Tweening.TweenCallback>(L, 2);
                    
                    gen_to_be_invoked.ButtonClickTween( _clickListener );
