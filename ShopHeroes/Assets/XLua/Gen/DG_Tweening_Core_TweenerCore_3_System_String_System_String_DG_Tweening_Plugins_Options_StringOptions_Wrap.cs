...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningCoreTweenerCore_3_SystemStringSystemStringDGTweeningPluginsOptionsStringOptions_Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>);
        ...
        {
            return LuaAPI.luaL_error(L, "DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> does not have a constructor!");
        }
        ...
        static int _m_ChangeStartValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                ...
                {
                    string _newStartValue = LuaAPI.lua_tostring(L, 2);
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 3);
                    
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeStartValue( _newStartValue, _newDuration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _newStartValue = LuaAPI.lua_tostring(L, 2);
                        ...
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeStartValue( _newStartValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.ChangeStartValue!");
        ...
        static int _m_ChangeEndValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _newEndValue = LuaAPI.lua_tostring(L, 2);
                    bool _snapStartValue = LuaAPI.lua_toboolean(L, 3);
                    
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _snapStartValue );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapStartValue = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _newDuration, _snapStartValue );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue, _newDuration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _newEndValue = LuaAPI.lua_tostring(L, 2);
                        ...
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeEndValue( _newEndValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.ChangeEndValue!");
        ...
        static int _m_ChangeValues(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _newStartValue = LuaAPI.lua_tostring(L, 2);
                    string _newEndValue = LuaAPI.lua_tostring(L, 3);
                    float _newDuration = (float)LuaAPI.lua_tonumber(L, 4);
                    
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeValues( _newStartValue, _newEndValue, _newDuration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _newEndValue = LuaAPI.lua_tostring(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_ret = gen_to_be_invoked.ChangeValues( _newStartValue, _newEndValue );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.ChangeValues!");
        ...
        static int _m_SetAutoKill(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetAutoKill!");
        ...
        static int _m_SetId(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetId!");
        ...
        static int _m_SetLink(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetLink!");
        ...
        static int _m_SetLoops(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetLoops!");
        ...
        static int _m_SetEase(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetEase!");
        ...
        static int _m_SetRecyclable(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetRecyclable!");
        ...
        static int _m_SetUpdate(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetUpdate!");
        ...
        static int _m_SetAs(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetAs!");
        ...
        static int _m_From(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.From!");
        ...
        static int _m_SetDelay(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetDelay!");
        ...
        static int _m_SetRelative(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetRelative!");
        ...
        static int _m_SetSpeedBased(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetSpeedBased!");
        ...
        static int _m_SetOptions(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& translator.Assignable<DG.Tweening.ScrambleMode>(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _scrambleChars = LuaAPI.lua_tostring(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.SetOptions( _richTextEnabled, _scrambleMode, _scrambleChars );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)&& translator.Assignable<DG.Tweening.ScrambleMode>(L, 3)) 
                {
                    bool _richTextEnabled = LuaAPI.lua_toboolean(L, 2);
                    DG.Tweening.ScrambleMode _scrambleMode;translator.Get(L, 3, out _scrambleMode);
                    
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.SetOptions( _richTextEnabled, _scrambleMode );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    bool _richTextEnabled = LuaAPI.lua_toboolean(L, 2);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.SetOptions( _richTextEnabled );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>.SetOptions!");
        ...
        static int _g_get_startValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.startValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_endValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.endValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_changeValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.changeValue);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_startValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.startValue = LuaAPI.lua_tostring(L, 2);
        ...
        static int _s_set_endValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.endValue = LuaAPI.lua_tostring(L, 2);
        ...
        static int _s_set_changeValue(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.changeValue = LuaAPI.lua_tostring(L, 2);
        ...
        static int _s_set_plugOptions(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                DG.Tweening.Plugins.Options.StringOptions gen_value;translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_getter(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.getter = translator.GetDelegate<DG.Tweening.Core.DOGetter<string>>(L, 2);
        ...
        static int _s_set_setter(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> gen_to_be_invoked = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.setter = translator.GetDelegate<DG.Tweening.Core.DOSetter<string>>(L, 2);
