...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIImageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetUIGrayColor", _m_SetUIGrayColor);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetUIGrayColor(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetUIGrayColor( _grayProgress );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> gen_ret = gen_to_be_invoked.DOFillAmount( _endValue, _duration );
                        translator.Push(L, gen_ret);
