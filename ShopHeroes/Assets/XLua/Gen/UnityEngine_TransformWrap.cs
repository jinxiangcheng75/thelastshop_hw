...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 61, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setLocalX", _m_setLocalX);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setLocalY", _m_setLocalY);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LocalPostionZero", _m_LocalPostionZero);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ClickTween", _m_ClickTween);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Fade_a_To_0_All", _m_Fade_a_To_0_All);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Fade_0_To_a_All", _m_Fade_0_To_a_All);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_setLocalX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.setLocalX( _x );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_setLocalY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.setLocalY( _y );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LocalPostionZero(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.LocalPostionZero(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClickTween(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Fade_a_To_0_All(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _needReset = LuaAPI.lua_toboolean(L, 4);
                    
                    gen_to_be_invoked.Fade_a_To_0_All( _a, _duration, _needReset );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Fade_a_To_0_All( _a, _duration );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.Fade_a_To_0_All!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Fade_0_To_a_All(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.Fade_0_To_a_All( _a, _duration, _delay );
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Fade_0_To_a_All( _a, _duration );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.Fade_0_To_a_All!");
