        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<int, int> gen_ret = new System.Collections.Generic.Dictionary<int, int>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<int, int> gen_ret = new System.Collections.Generic.Dictionary<int, int>(_capacity);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<int>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<int, int> gen_ret = new System.Collections.Generic.Dictionary<int, int>(_comparer);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<int>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<int, int> gen_ret = new System.Collections.Generic.Dictionary<int, int>(_capacity, _comparer);
					translator.Push(L, gen_ret);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.Dictionary<int, int>.Enumerator gen_ret = gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, gen_ret);
