...
namespace XLua.CSObjectWrap
{
    ...
    public class EventTriggerListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 11, 13, 13);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "onStartDrag", _g_get_onStartDrag);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "onEndDrag", _g_get_onEndDrag);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "enableDrag", _g_get_enableDrag);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "enablePass", _g_get_enablePass);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "onStartDrag", _s_set_onStartDrag);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "onEndDrag", _s_set_onEndDrag);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "enableDrag", _s_set_enableDrag);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "enablePass", _s_set_enablePass);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					EventTriggerListener gen_ret = new EventTriggerListener();
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        EventTriggerListener gen_ret = EventTriggerListener.Get( _go );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onStartDrag(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.onStartDrag);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_enableDrag(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.enableDrag);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_enablePass(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.enablePass);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_onDrag(RealStatePtr L)
        {
		    try {
                ...
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDrag = translator.GetDelegate<EventTriggerListener.VectorDelegate>(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onStartDrag(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onStartDrag = translator.GetDelegate<EventTriggerListener.VectorDelegate>(L, 2);
        ...
        static int _s_set_onEndDrag(RealStatePtr L)
        {
		    try {
                ...
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onEndDrag = translator.GetDelegate<EventTriggerListener.VectorDelegate>(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_enableDrag(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.enableDrag = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_enablePass(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                EventTriggerListener gen_to_be_invoked = (EventTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.enablePass = LuaAPI.lua_toboolean(L, 2);
