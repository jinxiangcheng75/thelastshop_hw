...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetActiveTrue", _m_SetActiveTrue);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetActiveFalse", _m_SetActiveFalse);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ChangeLayer", _m_ChangeLayer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "FindHideChildGameObject", _m_FindHideChildGameObject);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetActiveTrue(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetActiveTrue(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetActiveFalse(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetActiveFalse(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ChangeLayer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ChangeLayer( _layer );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindHideChildGameObject(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _childName = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.FindHideChildGameObject( _childName );
                        translator.Push(L, gen_ret);
